...
// DB Configuration
const CONNECTION_URI = process.env.MONGODB_URI || 'mongodb://muthu:muthu@cluster0-shard-00-00-kvmls.mongodb.net:27017,cluster0-shard-00-01-kvmls.mongodb.net:27017,cluster0-shard-00-02-kvmls.mongodb.net:27017/contact-manager?ssl=true&replicaSet=Cluster0-shard-0&authSource=admin&retryWrites=true'
